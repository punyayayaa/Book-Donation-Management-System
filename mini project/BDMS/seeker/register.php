...
if(isset($_POST['register'])){
    ...
    $query = "insert into seekers values(null,'$_POST[name]','$_POST[email]','$_POST[password]',$_POST[mobile],'$_POST[address]',1)";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../donor/login.html">Donor Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="login.html">Seeker Login</a>
                    </li>
                </ul>
                <form class="d-flex">
    ...
    <div class="container">
        <div class="row mt-3 text-center">
            ...
            <div class="col-md-4 mt-5">
                <h5 class="text-center mb-3 bg-warning p-1 text-black">Seeker's Register Page!</h5>
