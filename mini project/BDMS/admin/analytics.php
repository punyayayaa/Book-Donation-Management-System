<html>
    <body>
        ...
        <h5 class="text-center">Analytics Page!</h5><hr><br><br>
            <div class="col-md-4">
            <div class="card">
                <h5 class="card-header text-black bg-warning" styles="">Top Donor details</h5>
                <div class="card-body">
                <?php 
            ...
            <div class="col-md-4">
            <div class="card">
                <h5 class="card-header text-black bg-warning" styles="">Top Seeker details</h5>
                <div class="card-body">
                <?php 
                    include('../includes/connection.php');
            ...
            <div class="col-md-4">
            <div class="card">
                <h5 class="card-header text-black bg-warning" styles="">Top Demanded Category</h5>
                <div class="card-body">
                <?php 
                    include('../includes/connection.php');
