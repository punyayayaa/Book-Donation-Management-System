<?php
    ...
    if(isset($_POST['login'])){
        ...
        $query = "select email,password,name,id from donors where email = '$_POST[email]' AND password = '$_POST[password]'";
    ...
    <div class="container">
        <div class="row mt-3 text-center">
            ...
            <div class="col-md-4 mt-5">
                <h5 class="text-center mb-3 bg-warning p-1 text-black">Donor's Login Page!</h5>
