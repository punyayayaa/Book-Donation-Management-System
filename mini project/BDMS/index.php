...
<body>
    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #65b741;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Imprint Impact</a>
    ...
    <div class="container">
        <div class="row mb-5">
            <h3 class="text-center mt-2 mb-3"><u>Why Imprint Impact?</u></h3>
            <div class="col-md-4">
            ...
            <div class="col-md-6">
                ...
                <p class="para2">Imprint Impact aims to bridge this gap!</p>
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text"><p class="card-text">gl bajaj institute of technology and management</p>
                        <p>Pin Code - 201301</p></p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Email: imprintimpact@gmail.com</p>
                        <p>Business Email: business@imprintimpact.com</p>
                        <p>Contact Us On : 9087908756</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Imprint Impact is so popular among the people that you can ask people around you, you can easily reach to us.</p>
                        <p>See you soon...</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            ...
            <div class="col-md-12">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.828401910361!2d77.21081177542438!3d28.604924275679803!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce2bf29b99eef%3A0xabe7b86ddd02165e!2sAkbar%20Rd%2C%20Sunehri%20Bagh%20Road%20Area%2C%20Motilal%20Nehru%20Marg%20Area%2C%20New%20Delhi%2C%20Delhi!5e0!3m2!1sen!2sin!4v1702092096999!5m2!1sen!2sin" width="1300" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="footer">
            <p>Copyright &copy 2024 Imprint Impact</p>
        </div>
    </div>
</body>
